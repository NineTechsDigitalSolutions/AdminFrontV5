...
const CustomerCares = React.lazy(
	() => import('../pages/Notifications/CustomerCare')
)
const BulkNotifications = React.lazy(
	() => import('../pages/Notifications/BulkNotifications')
)

const MobileSetting = React.lazy(
	() => import('../pages/Settings/MobileSettings')
)
...
const ProductCategory = React.lazy(
	() => import('../pages/Shop/ProductCategory')
)
